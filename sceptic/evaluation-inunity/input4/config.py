...
# [USER-DEFINED INPUTS]
InputManager.create_input('CUSTOM_INPUT1', 'input1', 'i32')
InputManager.set_input_value('CUSTOM_INPUT1', '10')
InputManager.set_consistency_model('CUSTOM_INPUT1', InputManager.MOST_RECENT)

InputManager.create_input('CUSTOM_INPUT2', 'input2', 'i32')
InputManager.set_input_value('CUSTOM_INPUT2', '10')
InputManager.set_consistency_model('CUSTOM_INPUT2', InputManager.MOST_RECENT)

InputManager.create_input('CUSTOM_INPUT3', 'input3', 'i32')
InputManager.set_input_value('CUSTOM_INPUT3', '10')
InputManager.set_consistency_model('CUSTOM_INPUT3', InputManager.MOST_RECENT)

InputManager.create_input('CUSTOM_INPUT0', 'input0', 'i32')
InputManager.set_input_value('CUSTOM_INPUT0', '10')
InputManager.set_consistency_model('CUSTOM_INPUT0', InputManager.MOST_RECENT)

# [USER-DEFINED OUTPUTS]
OutputManager.create_output('NET', 'out', 'i32')
